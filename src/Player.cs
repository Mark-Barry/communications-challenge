...
namespace Com_Challenge.Classes.Character
{
    ...
    {   //verriables
        ...
        public string CurrentLocation { get { return this.GetCurrenetLocation(); } set { this.SetCurrenetLocation(); } }
        public string PreviousLocation { get { return this.GetPreviousLocation(); } set { this.SetPreviousLocation(); } }
